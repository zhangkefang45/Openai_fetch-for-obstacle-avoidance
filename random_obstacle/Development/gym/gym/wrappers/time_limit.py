...
class TimeLimit(gym.Wrapper):
    ...
    def get_object(self, name):
        return self.env.get_object(name)

    def random_set_object(self, name, xyz_range):
        self.env.random_set_object(name, xyz_range)

    def set_object(self, name, pos):
        self.env.set_object(name, pos)

    def get_object_range(self, name):
        return self.env.get_object_range(name)
